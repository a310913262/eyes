package com.cmcc.xpa.service.microservice.notes.task;




import com.cmcc.xpa.service.microservice.notes.task.jobs.QuartzJobFactory;
...
public class QuartzManager {
     ...
     * 查找一个定时任务
     */
    public static Boolean SelectJob(ScheduleJob scheduleJob) {
        try {
            Scheduler scheduler = schedulerFactory.getScheduler();
