package com.cmccsi.account.sync.accountsync.nessus.utils;
...
public class timeUtil {
    ...
    public static void main(String[] args) throws ParseException {
       ...
       Long l = 1545618859L;
        String string = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date(1545703462));
        Date date2=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(string);

        Date date1= longToDate(timeLong);

        String s = timeUtil.dateToString1(date2);
