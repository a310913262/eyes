...
public class HttpUtils {
     ...
     * @throws Exception
     */
    public static HttpResponse doPatch(String host, String path,
                                      Map<String, String> headers,
                                      Map<String, String> querys,
                                      String body)
            throws Exception {
     ...
     * @throws Exception
     */
    public static HttpResponse doDeletes(String host, String path,
                                        Map<String, String> headers,
                                        Map<String, String> querys,
                                         String body
    )
        ...
        HttpClient httpClient = wrapClient(host,path);
       // HttpDelete request = new HttpDelete(buildUrl(host, path, querys));
        HttpDeleteWithBody request = new HttpDeleteWithBody(buildUrl(host, path, querys));
        for (Map.Entry<String, String> e : headers.entrySet()) {
            request.addHeader(e.getKey(), e.getValue());
        }
        if (StringUtils.isNotBlank(body)) {
